...
const dummyLeaderboard = (
  <div className="table bg-white pt-2">
    <div className="table-row flex justify-center items-center">
      ...
      <img
        src={Marcello}
        className="table-cell w-12 rounded-full mb-2 mr-4 border-gray-600"
      />
      ...
      <img
        src={"https://image.flaticon.com/icons/svg/30/30090.svg"}
        className="table-cell w-8 rounded-full mb-2 ml-5 mr-4 border-gray-600"
      />
      <div className="table-cell align-middle pl-3 text-gray-600 font-xs">
        Baby
      </div>
    </div>
    <div className="table-row flex justify-center items-center">
    ...
    <div className="table-row flex justify-center items-center">
      ...
      <img
        src={"https://image.flaticon.com/icons/svg/1833/1833916.svg"}
        className="table-cell w-8 rounded-full mb-2 ml-5 mr-4 border-gray-600"
      />
      <div className="table-cell align-middle pl-3 text-gray-600 font-xs">
        Worm
...
const dummyOverall = (
  <div className="table bg-white pt-2">
    <div className="table-row flex justify-center items-center">
      ...
      <img
        src={"https://image.flaticon.com/icons/svg/862/862734.svg"}
        className="table-cell w-8 rounded-full mb-3 ml-5 mr-4 border-gray-600"
      />
      <div className="table-cell align-middle pl-3 text-gray-600 font-xs">
        Prince
      </div>
...
const dummyTeams = (
  <div className="table bg-white pt-2">
    <div className="table-row flex justify-center items-center">
      <div className="table-cell align-middle w-6">1.</div>
      <img
        src={"https://image.flaticon.com/icons/svg/1825/1825252.svg"}
        className="table-cell w-12 rounded-full mb-2 mr-4 border-gray-600"
      />
    ...
    <div className="table-row">
      <div className="table-cell align-middle w-6">2.</div>
      <img
        src={"https://image.flaticon.com/icons/svg/252/252590.svg"}
        className="table-cell w-12 rounded-full mb-2 mr-4 border-gray-600"
      />
    ...
    <div className="table-row">
      <div className="table-cell align-middle w-6">3.</div>
      <img
        src={"https://image.flaticon.com/icons/svg/426/426833.svg"}
        className="table-cell w-12 rounded-full mb-2 mr-4 border-gray-600"
      />
  ...
  return (
    <div className="mb-6">
      ...
      <Tabs>
        ...
        <TabPanel>{dummyLeaderboard}</TabPanel>
        <TabPanel>{dummyOverall}</TabPanel>
        <TabPanel>{dummyTeams}</TabPanel>
      </Tabs>
    </div>
  );
};
