...
const HistoryList = props => {
  return (
    <div>
      ...
      <div className="rounded shadow-lg bg-white py-2 px-4 m-2 flex flex-row">
        <img src={"https://image.flaticon.com/icons/svg/1836/1836945.svg"} className="w-20 h-20 self-center rounded-lg"/>
        <div className="pl-4">
      ...
      <div className="rounded shadow-lg bg-white py-2 px-4 m-2 flex flex-row">
        <img src={"https://image.flaticon.com/icons/svg/118/118377.svg"} className="w-20 h-20 self-center rounded-lg"/>
        <div className="pl-4">
      ...
      <div className="rounded shadow-lg bg-white py-2 px-4 m-2 flex flex-row">
        <img src={"https://image.flaticon.com/icons/svg/1864/1864285.svg"} className="w-20 h-20 self-center rounded-lg"/>
        <div className="pl-4">
      ...
      <div className="rounded shadow-lg bg-white py-2 px-4 m-2 flex flex-row">
        <img src={"https://image.flaticon.com/icons/svg/321/321828.svg"} className="w-20 h-20 self-center rounded-lg"/>
        <div className="pl-4">
