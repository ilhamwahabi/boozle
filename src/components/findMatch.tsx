    ...
    <div className="flex flex-col items-center bg-main min-h-screen">
      ...
      <div className="flex flex-col w-full">
        <div className="mb-3 mx-4 flex flex-col justify-center bg-white h-32 rounded-large shadow-lg">
          <div className="text-center text-strong-secondary text-2xl pb-2">Friendly Match</div>
        ...
        <div className="mt-3 mx-4 flex flex-col justify-center bg-white h-32 rounded-large shadow-lg">
          <div className="text-center text-strong-secondary text-2xl pb-2">Official Match</div>
          <div className="flex flex-row justify-center items-center">
      ...
      <Modal
        ...
        style={{overlay: {zIndex: 20, display:"flex", flexDirection: "column", alignItems: "center", justifyContent: "center"}, content: {height: "fit-content", top: "50%", transform: "translateY(-50%)"}}}
      >
        <h1 className={"text-primary text-2xl text-center pb-4"}>Create Room</h1>
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex flex-row justify-center items-center">
            <button className="bg-primary text-xl text-white h-10 w-100 rounded-lg">Submit</button>
          </div>
        </form>
      </Modal>
    </div>
